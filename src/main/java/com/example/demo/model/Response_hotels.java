...
public class Response_hotels {
	...
	public void setImages(List<HotelImages> images) {
		...
		for (HotelImages img : images) {
			arr.add(new Images_response(img.getId(),img.getHotels().getId(),img.getImageURL() ));
		}
		this.images = arr;
	}
	...
	public Response_hotels(long id, String name, String place, Double longitude, Double latitude, long phonenumber,
